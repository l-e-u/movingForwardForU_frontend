...
const EditJobForm = ({
   ...
   if ((prevJob.billing.length !== job.billing.length) || !prevJob.billing.every(bill => job.billing.some(b => ((bill._id === b.fee._id) && (String(bill.overrideAmount) === String(b.overrideAmount)))))) updatedProperties.billing = job.billing;
